...
const PostForm = ({post}) => {
    ...
    if(!post){
        ...
        <Row>
            <Col md='8'>
                <Image className='img-fluid hover-shadow' src={(post.url.startsWith('http') || post.url.startsWith('data')) ? post.url: noImage } alt="" style={{width: '750px', height: '500px'}}/>
            </Col>
    ...
    <div className='container'>
        ...
        <Row>
            <Col md='8'>
                <img className="img-fluid hover-shadow" src={(post.url.startsWith('http') || post.url.startsWith('data')) ? post.url: noImage }  style={{width: '750px', height: '500px'}} alt=""/>
            </Col>
